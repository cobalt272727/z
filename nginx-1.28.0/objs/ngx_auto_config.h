#define NGX_CONFIGURE " --prefix=/root/z/nginx --with-http_ssl_module --with-http_v2_module --with-mail --with-mail_ssl_module --with-http_stub_status_module --with-pcre-jit --with-pcre=/root/z/nginx-1.28.0/src/pcre2 --with-openssl=/root/z/nginx-1.28.0/src/openssl --with-zlib=/root/z/nginx-1.28.0/src/zlib"

#ifndef NGX_COMPILER
#define NGX_COMPILER  "gcc 14.2.0 (Ubuntu 14.2.0-19ubuntu2) "
#endif
...
#ifndef NGX_PREFIX
#define NGX_PREFIX  "/root/z/nginx/"
#endif
